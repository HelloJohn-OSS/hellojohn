-- Consolidated MySQL Tenant Schema
...
CREATE TABLE IF NOT EXISTS webhook_delivery (
    ...
    INDEX idx_wd_admin_list (webhook_id, created_at DESC),
    INDEX idx_wd_admin_status (webhook_id, status, created_at DESC),
    INDEX idx_wd_admin_event (webhook_id, event_type, created_at DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ─── 16. WebAuthn Credentials ───
